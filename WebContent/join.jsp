...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<form action="joinok.kakao" method ="post">
    ...
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <div class="alert alert-success" id="email-success">사용 가능한 이메일 입니다.</div>
			<div class="alert alert-danger" id="email-danger">중복된 이메일 입니다..</div>
		</div>
    </div> <!-- form-group// -->   
    ...
    <div class="form-group input-group">
    	...
    	<input name="phone2" class="form-control" placeholder="번호" type="text">
    </div> <!-- form-group// -->
    ...
    <p class="text-center">아이디가 있으신가요? <a href="login.kakao">로그인</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
...
<script type="text/javascript">
    $(function(){
        $("#alert-success").hide();
        $("#alert-danger").hide();
        $("#repw").keyup(function(){ //"#" id , "." : class 없으면 태그 -> input 태그
//         	consloe.log("눌렀다");
            var pwd1=$("#pw").val();
            var pwd2=$("#repw").val();
            console.log("pw: "+pwd1);
